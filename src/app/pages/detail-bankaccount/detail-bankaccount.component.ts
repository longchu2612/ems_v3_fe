...
@Component({
  selector: 'app-detail-bankaccount',
  templateUrl: './detail-bankaccount.component.html',
  styleUrls: ['./detail-bankaccount.component.scss']
})
export class DetailBankaccountComponent implements OnInit {
  ...
  fetchData() {
    ...
    this.apiService.getList(this.tableName + this.id).subscribe({
      next: (res) => {
        this.data = res
